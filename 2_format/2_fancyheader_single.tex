\documentclass[12pt,a4paper,titlepage]{article} % legyen külön oldal, jelezze a hibákat
...
\fancyhf{} 	% Takarít
% Egyoldalas dokumentum esetén fejléc
\lhead{\thepage}
\chead{\leftmark}
\rhead{\thesection . fejezet}
% Egyoldalas dokumentum esetén a lábjegyzet
\lfoot{\today}
\cfoot{\thepage}
\rfoot{Szerző, T. et al.}
